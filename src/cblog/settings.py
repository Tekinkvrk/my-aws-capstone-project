...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cpth6qnwjx89.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonestekinblog' # please enter your s3 bucket name
